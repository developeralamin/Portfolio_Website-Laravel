            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Add BennarText </h4>
                </div>
                <div class="card-body">
    <form class="forms-sample" method="post" action="{{  route('benner.store')  }}" enctype="multipart/form-data">
    @csrf
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <input type="text" name="benner_title" class="form-control">
              ...
              {{ ($errors->has('benner_title'))?($errors->first('benner_title')):'' }}
                      ...
                      <div class="col-md-8">
                        <div class="form-group">
                          ...
                          <textarea rows="10" cols="20" class="form-control" name="benner_sub"></textarea>
                  <font style="color: red">
               ...
               <div class="col-md-8">
                    <div class="form-group">
                      <label class="bmd-label-floating">Bennar Another Title</label>
                        <input type="text" name="benner_sub_title" class="form-control">
                          <font style="color: red">
